package com.flyway.migration.bb.demoapp.service;
...
import com.flyway.migration.bb.service.ProductServiceImpl;
...
public class ProductServiceTest {
    ...
    public void findProductById_shouldReturnProduct_whenProductIdIsFound() throws ProductNotFoundException, ProductAlreadyExistsException {
        ...
        //Given
        Product newProduct = createProduct(1L,"Celular Samsumg J7","Celular Samsung Galaxy J7", 710.00);

        //When
        when(productRepository.findOne(eq(newProduct.getId()))).thenReturn(newProduct);
        Product productSearched = productService.findProductById(newProduct.getId());
    ...
    public void removeProduct_shouldReturnProductNotFoundException_whenProductDoesNotExistInTheDatabase()throws ProductNotFoundException {
        ...
        //When
        when(productRepository.findOne(eq(newProduct.getId()))).thenReturn(null);
        thrown.expect(ProductNotFoundException.class);
